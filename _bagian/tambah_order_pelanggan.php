  <section id="tambah_order_pelanggan" class="book-a-table">
      <div class="container" data-aos="fade-up">
        ...
        <form action="_bagian/add_order.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 form-group">
              <input type="number" name="id_user" class="form-control" id="id_user" placeholder="Masukkan Id User" data-rule="minlen:4" data-msg="Please enter at least 4 chars" value="<?php echo $_GET['id']; ?>">
              <div class="validate"></div>
            </div>
            <div class="col-lg-4 col-md-6 form-group">
            ...
            <div class="col-lg-4 col-md-6 form-group">
              <input type="number" name="status_order" class="form-control" id="status_order" placeholder="Masukkan Status Order" data-rule="minlen:4" data-msg="Please enter at least 4 chars" value=1>
              <div class="validate"></div>
            </div>
          </div>
