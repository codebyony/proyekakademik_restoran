        ...
        <div class="">
          ...
          <table class="table table-striped table-light table-bordered table-hover">
            ...
            <tr>
              ...
              <td>
                <button type="button" class="btn btn-success" onclick="location.href='./menu_admin.php?id=<?php echo $row['id_masakan'];?>&edit=1'">Edit</button>
                <button type="button" class="btn btn-danger" onclick="location.href='./_bagian/delete_menu.php?id=<?php echo $row['id_masakan'];?>'">Hapus</button>
              </td>
            </tr>
            <?php
                }
